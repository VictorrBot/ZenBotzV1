...
╭─━• 「 Owner 」 
│ ⸙͎۪۫ !setmenu [query]
│ ⸙͎۪۫ !setmenu templateLocation
│ ⸙͎۪۫ !setmenu templateTenor
│ ⸙͎۪۫ !setmenu katalog
│ ⸙͎۪۫ !setmenu katalog2
│ ⸙͎۪۫ !setmenu list
│ ⸙͎۪۫ !setwm packname|author
│ ⸙͎۪۫ !sendsesi
│ ⸙͎۪۫ !listpc
│ ⸙͎۪۫ !listgc
│ ⸙͎۪۫ !broadcast [text]
...
│ ⸙͎۪۫ !nsfw [on/off]
│ ⸙͎۪۫ !mute [on/off]
│ ⸙͎۪۫ !autoblok212 [on/off]
│ ⸙͎۪۫ !banchat
│ ⸙͎۪۫ !unbanchat
│ ⸙͎۪۫ !autorespond [on/off]
│ ⸙͎۪۫ !antiviewonce [on/off]
│ ⸙͎۪۫ !autobio [on/off]
│ ⸙͎۪۫ !join [link]
│ ⸙͎۪۫ !self
│ ⸙͎۪۫ !public [only bot]
│ ⸙͎۪۫ !del [reply pesan bot]
│ ⸙͎۪۫ !pppanjang
│ ⸙͎۪۫ !setpppanjang
│ ⸙͎۪۫ !setppbot [reply image]
╰───────━⃝┅⃝━──────┘

╭─━• 「 Store Menu 」
│ ⸙͎۪۫ !list
│ ⸙͎۪۫ !addlist [key|respond]
│ ⸙͎۪۫ !dellist [key]
│ ⸙͎۪۫ !update [key|respond]
│ ⸙͎۪۫ !store
│ ⸙͎۪۫ !kali
│ ⸙͎۪۫ !bagi
│ ⸙͎۪۫ !tambah
...
╭─━• 「 Database 」 
│ ⸙͎۪۫ !setcmd [reply stiker]
│ ⸙͎۪۫ !delcmd [reply stiker]
│ ⸙͎۪۫ !listcmd
│ ⸙͎۪۫ !absen
│ ⸙͎۪۫ !cekabsen
│ ⸙͎۪۫ !deleteabsen
│ ⸙͎۪۫ !absenstart
│ ⸙͎۪۫ !addmsg [nama file]
│ ⸙͎۪۫ !getmsg [nama file]
│ ⸙͎۪۫ !listmsg
│ ⸙͎۪۫ !delmsg [nama file]
╰───────━⃝┅⃝━──────┘
...
│ ⸙͎۪۫ !listonline
│ ⸙͎۪۫ !sider
│ ⸙͎۪۫ !wm packname|author
│ ⸙͎۪۫ !infochat
│ ⸙͎۪۫ !setdesk [text]
│ ⸙͎۪۫ !setppgrup [reply image]
│ ⸙͎۪۫ !pppanjanggc
│ ⸙͎۪۫ !setpppanjanggc
│ ⸙͎۪۫ !revoke
│ ⸙͎۪۫ !leave
...
│ ⸙͎۪۫ !welcome [on/off]
│ ⸙͎۪۫ !goodbye [on/off]
│ ⸙͎۪۫ !demotedetect [on/off]
│ ⸙͎۪۫ !promotedetect  [on/off]
│ ⸙͎۪۫ !setwelcome
│ ⸙͎۪۫ !updatewelcome
│ ⸙͎۪۫ !delwelcome
│ ⸙͎۪۫ !cekwelcome
...
│ ⸙͎۪۫ !nsfw [on/off]
│ ⸙͎۪۫ !antilink [on/off]
│ ⸙͎۪۫ !take packname|author
│ ⸙͎۪۫ !group [open/close]
│ ⸙͎۪۫ !tagall [text]
│ ⸙͎۪۫ !hidetag [text]
╰───────━⃝┅⃝━──────┘
...
╭─━• 「 Stalking 」 
│ ⸙͎۪۫ !igstalk [username]
│ ⸙͎۪۫ !ghstalk [username]
│ ⸙͎۪۫ !ytstalk [channel]
╰───────━⃝┅⃝━──────┘
...
│ ⸙͎۪۫ !tomp3 [video]
│ ⸙͎۪۫ !tovn [video]
│ ⸙͎۪۫ !stiker [reply image]
│ ⸙͎۪۫ !tourl [image/video/stiker]
│ ⸙͎۪۫ !togif [sticker]
│ ⸙͎۪۫ !tomp4 [sticker]
│ ⸙͎۪۫${prefix}toimg [reply sticker]
╰───────━⃝┅⃝━──────┘


╭─━• 「 Image Effect 」 
│ ⸙͎۪۫ !wanted [reply image/stiker]
│ ⸙͎۪۫ !utatoo [reply image/stiker]
│ ⸙͎۪۫ !unsharpen [reply image/stiker]
│ ⸙͎۪۫ !thanos [reply image/stiker]
│ ⸙͎۪۫ !sniper [reply image/stiker]
│ ⸙͎۪۫ !sharpen [reply image/stiker]
│ ⸙͎۪۫ !sepia [reply image/stiker]
│ ⸙͎۪۫ !scary [reply image/stiker]
│ ⸙͎۪۫ !rip [reply image/stiker]
│ ⸙͎۪۫ !redple [reply image/stiker]
│ ⸙͎۪۫ !rejected [reply image/stiker]
│ ⸙͎۪۫ !posterize [reply image/stiker]
│ ⸙͎۪۫ !ps4 [reply image/stiker]
│ ⸙͎۪۫ !pixelize [reply image/stiker]
│ ⸙͎۪۫ !missionpassed [reply image/stiker]
│ ⸙͎۪۫ !moustache [reply image/stiker]
│ ⸙͎۪۫ !lookwhatkarenhave [reply image/stiker]
│ ⸙͎۪۫ !jail [reply image/stiker]
│ ⸙͎۪۫ !invert [reply image/stiker]
│ ⸙͎۪۫ !instagram [reply image/stiker]
│ ⸙͎۪۫ !greyscale [reply image/stiker]
│ ⸙͎۪۫ !glitch2 [reply image/stiker]
│ ⸙͎۪۫ !gay [reply image/stiker]
│ ⸙͎۪۫ !frame [reply image/stiker]
│ ⸙͎۪۫ !fire [reply image/stiker]
│ ⸙͎۪۫ !distort [reply image/stiker]
│ ⸙͎۪۫ !dictator [reply image/stiker]
│ ⸙͎۪۫ !deepfry [reply image/stiker]
│ ⸙͎۪۫ !ddungeon [reply image/stiker]
│ ⸙͎۪۫ !circle [reply image/stiker]
│ ⸙͎۪۫ !challenger [reply image/stiker]
│ ⸙͎۪۫ !burn [reply image/stiker]
│ ⸙͎۪۫ !brazzers [reply image/stiker]
│ ⸙͎۪۫ !beautiful [reply image/stiker]
╰───────━⃝┅⃝━──────┘


╭─━• 「 Sticker Effect 」 
│ ⸙͎۪۫ !jail [reply image/stiker]
│ ⸙͎۪۫ !red [reply image/stiker]
│ ⸙͎۪۫ !gay [reply image/stiker]
│ ⸙͎۪۫ !bloo [reply image/stiker]
│ ⸙͎۪۫ !blue [reply image/stiker]
│ ⸙͎۪۫ !sepia [reply image/stiker]
│ ⸙͎۪۫ !green [reply image/stiker]
│ ⸙͎۪۫ !glass [reply image/stiker]
│ ⸙͎۪۫ !invert [reply image/stiker]
│ ⸙͎۪۫ !blurple [reply image/stiker]
│ ⸙͎۪۫ !blurple2 [reply image/stiker]
│ ⸙͎۪۫ !wasted [reply image/stiker]
│ ⸙͎۪۫ !passed [reply image/stiker]
│ ⸙͎۪۫ !triggered [reply image/stiker]
│ ⸙͎۪۫ !comrade [reply image/stiker]
│ ⸙͎۪۫ !greyscale [reply image/stiker]
│ ⸙͎۪۫ !threshold [reply image/stiker]
│ ⸙͎۪۫ !brightness [reply image/stiker]
│ ⸙͎۪۫ !invertgreyscale [reply image/stiker]
╰───────━⃝┅⃝━──────┘
...
│ ⸙͎۪۫ !igtv [link]
│ ⸙͎۪۫ !soundcloud [link]
│ ⸙͎۪۫ !gitclone [link repo]
│ ⸙͎۪۫ !gitrepo [username repo branch]
│ ⸙͎۪۫ !mediafire [link]
│ ⸙͎۪۫ !twitter link
╰───────━⃝┅⃝━──────┘

╭─━• 「 Primbon 」
│ ⸙͎۪۫ !nomorhoki 887435047326
│ ⸙͎۪۫ !artimimpi [query]
│ ⸙͎۪۫ !artinama [query]
│ ⸙͎۪۫ !ramaljodoh
│ ⸙͎۪۫ !ramaljodohbali
...
╭─━• 「 Textpro Menu 」
│ ⸙͎۪۫ !halloween2 text|text2
│ ⸙͎۪۫ !horror text|text2
│ ⸙͎۪۫ !game8bit text|text2
│ ⸙͎۪۫ !layered text|text2
│ ⸙͎۪۫ !glitch2 text|text2
│ ⸙͎۪۫ !coolg text|text2
│ ⸙͎۪۫ !coolwg text|text2
│ ⸙͎۪۫ !realistic text|text2
│ ⸙͎۪۫ !space3d text|text2
│ ⸙͎۪۫ !gtiktok text|text2
│ ⸙͎۪۫ !stone text|text2
│ ⸙͎۪۫ !marvel text|text2
│ ⸙͎۪۫ !marvel2 text|text2
│ ⸙͎۪۫ !pornhub text|text2
│ ⸙͎۪۫ !avengers text|text2
│ ⸙͎۪۫ !metalr text|text2
│ ⸙͎۪۫ !metalg text|text2
│ ⸙͎۪۫ !metalg2 text|text2
│ ⸙͎۪۫ !halloween2 text|text2
│ ⸙͎۪۫ !lion text|text2
│ ⸙͎۪۫ !wolf_bw text|text2
│ ⸙͎۪۫ !wolf_g text|text2
│ ⸙͎۪۫ !ninja text|text2
│ ⸙͎۪۫ !3dsteel text|text2
│ ⸙͎۪۫ !horror2 text|text2
│ ⸙͎۪۫ !lava text|text2
│ ⸙͎۪۫ !bagel text|text2
│ ⸙͎۪۫ !blackpink text
│ ⸙͎۪۫ !rainbow2 text
│ ⸙͎۪۫ !water_pipe text
│ ⸙͎۪۫ !halloween text
...
╭─━• 「 Others 」
│ ⸙͎۪۫ !afk [reason]
│ ⸙͎۪۫ !translate kode_bahasa text
│ ⸙͎۪۫ !kalkulator [query]
│ ⸙͎۪۫ !smeme [text]
│ ⸙͎۪۫ !smeme2 [text|text]
│ ⸙͎۪۫ !memegen [text|text]
╰───────━⃝┅⃝━──────┘
...
╭─━• 「 Logo Menu 」
│ ⸙͎۪۫ !coverbannerlol text|heroes
│ ⸙͎۪۫ !pubglogomaker text|style
│ ⸙͎۪۫ !colorfulpubg text|color
│ ⸙͎۪۫ !astronotspace text|style
│ ⸙͎۪۫ !wallpaperaov text|heroes
│ ⸙͎۪۫ !maketeamlogo text|style
│ ⸙͎۪۫ !circlemarcotteam text|logo
│ ⸙͎۪۫ !wallpaperml text|heroes
│ ⸙͎۪۫ !dragonballfb text|character
│ ⸙͎۪۫ !bannerofaov text|character
│ ⸙͎۪۫ !effect3donbeach text|background
│ ⸙͎۪۫ !cutegirlgamer text|logo
│ ⸙͎۪۫ !footballteam text|logo
│ ⸙͎۪۫ !beautifulshimmering text|champion
│ ⸙͎۪۫ !pubgcutelogo text|logo
│ ⸙͎۪۫ !elegantrotation text|logo
│ ⸙͎۪۫ !logogamingassasin text|logo
│ ⸙͎۪۫ !introvideomaker text|logo
│ ⸙͎۪۫ !gaminglogo4fvs text|logo
│ ⸙͎۪۫ !blueneon text|logo
│ ⸙͎۪۫ !metalmascot text|logo
│ ⸙͎۪۫ !anonymous2 text|style
│ ⸙͎۪۫ !lolpentakill text|style
│ ⸙͎۪۫ !avatarleagueofking text|style
│ ⸙͎۪۫ !avatarff text|character
│ ⸙͎۪۫ !overwatchwallpaper text|character
│ ⸙͎۪۫ !rovwallpaperhd text|hero
│ ⸙͎۪۫ !rovwallpaper text|avatar
│ ⸙͎۪۫ !beautifulgalaxylol text|style
│ ⸙͎۪۫ !crossfirecover text|character
│ ⸙͎۪۫ !lolwallpaper text|wallpaper
│ ⸙͎۪۫ !coverdota2 text|heroes
│ ⸙͎۪۫ !coverleagueofking text|character
│ ⸙͎۪۫ !avatar3q360 text|avatar
│ ⸙͎۪۫ !coverofwarface text|character
│ ⸙͎۪۫ !newlolavatar text|avatar
│ ⸙͎۪۫ !csgocover text|background
│ ⸙͎۪۫ !coverloknew text|hero
│ ⸙͎۪۫ !coverfblol text|letters
│ ⸙͎۪۫ !overwatchcover text|hero
│ ⸙͎۪۫ !crossfirestyle text|avatar
│ ⸙͎۪۫ !avatarlolbyname text|style
│ ⸙͎۪۫ !lolcoverbyname text|avatar
│ ⸙͎۪۫ !cyberhunterfb text|character
│ ⸙͎۪۫ !coverfreefirefb text|character
│ ⸙͎۪۫ !gamingmascot text|style
│ ⸙͎۪۫ !coveronepiecefb text|character
│ ⸙͎۪۫ !bannerytcsgo text|banner
│ ⸙͎۪۫ !fbgamepubgcover text|template
│ ⸙͎۪۫ !banneroflol text|text2|banner
│ ⸙͎۪۫ !bannerofaov2 text|text2|banner
│ ⸙͎۪۫ !teamlogo text|text2|background
│ ⸙͎۪۫ !companylogo2 text|text2|background
│ ⸙͎۪۫ !companylogo text|text2|background
│ ⸙͎۪۫ !gradientlogo text|text2|background
│ ⸙͎۪۫ !pencilsketch text|text2|icon
│ ⸙͎۪۫ !gunlogogaming text|text2|background
│ ⸙͎۪۫ !banneroffreefire text|text2|background
│ ⸙͎۪۫ !letterlogos text|text2|thumb
│ ⸙͎۪۫ !bannerofoverwatch text|text2|background
│ ⸙͎۪۫ !bannerofapex text|text2|background
│ ⸙͎۪۫ !bannerofpubg text|text2|background
│ ⸙͎۪۫ !mascotstyle text|text2|thumb
│ ⸙͎۪۫ !logoaccording text|text2|thumb
│ ⸙͎۪۫ !avataroverwatch text|text2|thumb
╰───────━⃝┅⃝━──────┘
...
│ ⸙͎۪۫ !asmaulhusna
│ ⸙͎۪۫ !kisahnabi [nabi]
│ ⸙͎۪۫ !jadwalshalat [daerah]
│ ⸙͎۪۫ !randomquran
│ ⸙͎۪۫ !randomquran2
│ ⸙͎۪۫ !listsurah
│ ⸙͎۪۫ !tafsirsurah [surah]
│ ⸙͎۪۫ !alquranaudio [surah|ayat]
╰───────━⃝┅⃝━──────┘
...
╭─────[ *RULES* ]─────✧
┴
│¹ Dilarang Jual Sc Ini!!
│² Dilarang Spam Command, Banned!
│³ Dilarang Kirim Virtex
│⁴ Dilarang Spam Menu Ga Jelas
│⁵ Dilarang Telp / Vc Bot/Owner
│⁶ Dilarang Culik Bot
│⁷ Dilarang Promosi
│⁸ Dilarang Meniru pesan ZEN BOT
...
│ ⸙͎۪۫ !youtubegold text
│ ⸙͎۪۫ !youtubesilver text
│ ⸙͎۪۫ !facebookgold text
│ ⸙͎۪۫ !facebooksilver text
│ ⸙͎۪۫ !instagramgold text
│ ⸙͎۪۫ !instagramsilver text
│ ⸙͎۪۫ !twittergold text
│ ⸙͎۪۫ !twittersilver text
│ ⸙͎۪۫ !retrotext text
│ ⸙͎۪۫ !halloweenbats text
│ ⸙͎۪۫ !texthalloween text
│ ⸙͎۪۫ !cardhalloween text
│ ⸙͎۪۫ !birthdaycake text
│ ⸙͎۪۫ !thundertext text
│ ⸙͎۪۫ !icetext text
│ ⸙͎۪۫ !milkcake text
│ ⸙͎۪۫ !snowontext text
│ ⸙͎۪۫ !metalstar text
...
│ ⸙͎۪۫ !zombie3d text
│ ⸙͎۪۫ !merrycard text
│ ⸙͎۪۫ !generalexam text 
│ ⸙͎۪۫ !viettel text
│ ⸙͎۪۫ !embroider text
│ ⸙͎۪۫ !graffititext text
│ ⸙͎۪۫ !graffititext2 text
│ ⸙͎۪۫ !graffititext3 text
│ ⸙͎۪۫ !covergraffiti text
│ ⸙͎۪۫ !moderngold text
│ ⸙͎۪۫ !capercut text
│ ⸙͎۪۫ !lovecard text
│ ⸙͎۪۫ !heartflashlight text
│ ⸙͎۪۫ !heartcup text
│ ⸙͎۪۫ !sunglightshadow text
│ ⸙͎۪۫ !graffiti3d text
│ ⸙͎۪۫ !moderngoldsilver text
│ ⸙͎۪۫ !moderngold2 text
│ ⸙͎۪۫ !moderngold3 text
│ ⸙͎۪۫ !fabrictext text
│ ⸙͎۪۫ !masteryavatar text
│ ⸙͎۪۫ !messagecoffee text
│ ⸙͎۪۫ !announofwin text
│ ⸙͎۪۫ !writeblood text
│ ⸙͎۪۫ !horrorletter text
│ ⸙͎۪۫ !writehorror text
│ ⸙͎۪۫ !shirtclub text
│ ⸙͎۪۫ !angelwing text
│ ⸙͎۪۫ !christmasseason text
│ ⸙͎۪۫ !projectyasuo text
│ ⸙͎۪۫ !lovelycute text
│ ⸙͎۪۫ !womansday text
│ ⸙͎۪۫ !covergamepubg text
│ ⸙͎۪۫ !nameonheart text
│ ⸙͎۪۫ !funnyhalloween text
│ ⸙͎۪۫ !lightningpubg text
│ ⸙͎۪۫ !greetingcardvideo text 
│ ⸙͎۪۫ !christmascard text 
│ ⸙͎۪۫ !galaxybat text
│ ⸙͎۪۫ !writegalaxy text
│ ⸙͎۪۫ !starsnight text
│ ⸙͎۪۫ !noeltext text
│ ⸙͎۪۫ !textcakes text
│ ⸙͎۪۫ !pubgbirthday text
│ ⸙͎۪۫ !galaxywallpaper text
│ ⸙͎۪۫ !pubgglicthvideo text 
│ ⸙͎۪۫ !pubgmascotlogo text
│ ⸙͎۪۫ !realembroidery text
│ ⸙͎۪۫ !vintagetelevision text
│ ⸙͎۪۫ !funnyanimations text
│ ⸙͎۪۫ !glowingtext text
│ ⸙͎۪۫ !textonglass text
│ ⸙͎۪۫ !cartoonstyle text
│ ⸙͎۪۫ !multicolor text
│ ⸙͎۪۫ !watercolor2 text
│ ⸙͎۪۫ !textsky text
│ ⸙͎۪۫ !summerbeach text
│ ⸙͎۪۫ !1917text text
│ ⸙͎۪۫ !puppycute text
│ ⸙͎۪۫ !rosebirthday text
│ ⸙͎۪۫ !steellettering text|text2
│ ⸙͎۪۫ !letterstext text|text2
│ ⸙͎۪۫ !barcashirt text|text2
│ ⸙͎۪۫ !premiercup text|text2
│ ⸙͎۪۫ !stylepoligon text|text2
│ ⸙͎۪۫ !lifebuoys text|text2
│ ⸙͎۪۫ !juventusshirt text|text2`
╰───────━⃝┅⃝━──────┘
}
...
│ ⸙͎۪۫ !battlegrounds-logo
│ ⸙͎۪۫ !battlefield4
│ ⸙͎۪۫ !text-8bit
│ ⸙͎۪۫ !typography-flower 
│ ⸙͎۪۫ !under-flower 
│ ⸙͎۪۫ !bevel-text 
│ ⸙͎۪۫ !silk-text 
│ ⸙͎۪۫ !sweet-andy 
│ ⸙͎۪۫ !smoke-typography 
│ ⸙͎۪۫ !carvedwood 
│ ⸙͎۪۫ !scary-cemetery 
│ ⸙͎۪۫ !royallook 
│ ⸙͎۪۫ !coffeecup2 
...
│ ⸙͎۪۫ !rainbow-shine 
│ ⸙͎۪۫ !smoky-neon 
│ ⸙͎۪۫ !quotes-underfall //
│ ⸙͎۪۫ !layered-leaves 
│ ⸙͎۪۫ !vector-nature 
│ ⸙͎۪۫ !yellow-rose 
│ ⸙͎۪۫ !love-text 
│ ⸙͎۪۫ !underwater-ocean 
│ ⸙͎۪۫ !nature-text 
│ ⸙͎۪۫ !wolf-metal 
│ ⸙͎۪۫ !summer-text 
│ ⸙͎۪۫ !wooden-board //
...
│ ⸙͎۪۫ !quote-wood 
│ ⸙͎۪۫ !love-text 
│ ⸙͎۪۫ !quotes-undergrass 
│ ⸙͎۪۫ !naruto-banner 
│ ⸙͎۪۫ !love-message 
│ ⸙͎۪۫ !textoncup2 
│ ⸙͎۪۫ !burn-paper 
│ ⸙͎۪۫ !smoke 
│ ⸙͎۪۫ !romantic-messages 
│ ⸙͎۪۫ !shadow-sky 
│ ⸙͎۪۫ !text-cup 
│ ⸙͎۪۫ !coffecup
╰───────━⃝┅⃝━──────┘
